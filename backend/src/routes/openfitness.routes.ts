 ...
 */
    .get('/notion/:type', async (c: Context) => {
        ...
        try {
            ...
            const notionPageContentWithChildren = await new Promise((resolve, reject) => {
                // const notionPageContentWithChildren = 
            ...
            return c.json({ markdown, images, notionPageContent: notionPageContentWithChildren });
